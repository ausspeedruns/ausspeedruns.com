...
export const metadata: Metadata = {
	title: "Policies",
	description: "AusSpeedruns's policies",
};
	...
	return (
		<div className={styles.app}>
			...
			<main className={styles.content}>
				<h2>Policies</h2>
				<p>
					<a target="_blank" rel="noreferrer noopener" href="http://policies.ausspeedruns.com/">
				...
				<div className={styles.privacypolicy}>
					...
					<p>
						...
						Policy has been created with the help of a template
					</p>
					{/* <div style='margin-top:0cm;margin-right:0cm;margin-bottom:10.0pt;margin-left:0cm;line-height:115%;font-size:15px;font-family:"Cambria",serif;border:none;border-bottom:solid #4F81BD 1.0pt;padding:0cm 0cm 4.0pt 0cm;'> */}
					...
					<p className={styles.indented}>
						...
						&quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to AusSpeedruns
					</p>
					<p className={styles.indented}>
					...
					<p className={styles.indented}>
						<strong>Website</strong> refers to AusSpeedruns, accessible from{" "}
						<a href="www.ausspeedruns.com" target="_blank" rel="noreferrer">
							www.ausspeedruns.com
						</a>
					</p>
					<p className={styles.indented}>
					...
					<p className={styles.indented}>Email address</p>
					<p className={styles.indented}>First name and last name</p>
					<p className={styles.indented}>Social Media information (such as Discord ID)</p>
					<p className={styles.indented}>Usage Data</p>
					<h3>Usage Data</h3>
					...
					<p className={styles.indented}>Type: Session Cookies</p>
					<p className={styles.indented}>Administered by: Us</p>
					<p className={styles.indented}>
					...
					<p className={styles.indented}>Type: Persistent Cookies</p>
					<p className={styles.indented}>Administered by: Us</p>
					<p className={styles.indented}>
					...
					<ul>
						...
						<li>
							We will never sell your personal information as a service to advertisers or similar
							organisations, however note that personal information may be included within business
							transfers, in relation to business partners, or similar, in the context of above noted
							scenarios. We will also only share what personal information is needed to effect the
							scenario, for example contact information in relational to prize support partners
						</li>
					</ul>
					...
					<p>
						We will let You know via notification on Discord at the appropriate place, prior to the change
					...
					{/* </div> */}
					<p>
						If you have any questions about this Privacy Policy, You can contact us via Discord, or via any
						AusSpeedruns social media&nbsp;
					</p>
				</div>
			</main>
		</div>
