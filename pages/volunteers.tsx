...
export default function SubmitGamePage() {
	...
	switch (jobType) {
		case 'host':
			if (isNaN(eventHostTime) || eventHostTime <= 0 || isNaN(maxDailyHostTime) || maxDailyHostTime <= 0 || !dayTimes) {
				disableSend = true;
			}
			break;
		case 'runMgmt':
						...
						<>
							...
							{jobType === 'host' && (
								<>
									...
									<div className={styles.question}>
										<span>What is the maximum amount of hours you are comfortable hosting for in one sitting?*</span>
