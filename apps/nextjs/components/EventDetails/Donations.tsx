...
const Donations = () => {
	const donationUrl =
		"https://api.raisely.com/v3/profiles/b37711e0-8eb2-11eb-bbdb-558a75b6889f/donations?offset=0&isSuspicious=false&limit=3&sort=createdAt&order=desc&campaign=c660c910-0ddc-11eb-982d-2522a70939d9";
	...
	const getNextTick = () => {
		fetch(donationUrl, {
			...
			.then((res) => {
				const donationsData = [
					...res.data.map((donation: Dictionary) => {
						return {
