			...
			<main className={styles.content}>
				...
				<div className={styles.privacypolicy}>
					...
					<p>
						...
						created with the help of a template
					</p>
					...
					<p className={styles.indented}>
						...
						&quot;Our&quot; in this Agreement) refers to AusSpeedruns
					</p>
					<p className={styles.indented}>
					...
					<p className={styles.indented}>
						...
						<a href="www.ausspeedruns.com" target="_blank" rel="noreferrer">www.ausspeedruns.com</a>
					</p>
					<p className={styles.indented}>
					...
					<ul>
						...
						<li>
							We will never sell your personal information as a service to advertisers or similar organisations, however
							note that personal information may be included within business transfers, in relation to business
							partners, or similar, in the context of above noted scenarios. We will also only share what personal
							information is needed to effect the scenario, for example contact information in relational to prize
							support partners
						</li>
					</ul>
					...
					<p>
						We will let You know via notification on Discord at the appropriate place, prior to the change becoming
					...
					{/* </div> */}
					<p>
						If you have any questions about this Privacy Policy, You can contact us via Discord, or via any AusSpeedruns
						social media&nbsp;
					</p>
				</div>
			</main>
