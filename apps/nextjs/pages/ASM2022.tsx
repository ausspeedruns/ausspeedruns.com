	...
	return (
		<div>
			<Head>
				...
				<DiscordEmbed
					title="ASM2022 - AusSpeedruns"
					pageUrl="/event/ASM2022"
				/>
			</Head>
			<div className={styles.header}>
				...
				<div className={styles.buttons}>
					...
					{queryResult.data?.event?.acceptingShirts && (
						<Button
							actionText="Buy the ASM2022 Shirt! (Limited Time)"
							link="/store"
							iconRight={faShirt}
						/>
					)}
					...
					<Button
						actionText="Donation Challenges"
			...
			<main>
				<div className={styles.contentRow}>
					<div className={styles.intro}>
						...
						<p>
							ASM2022 is a speedrunning event, featuring
							exhibitions of talent from all across Australia, as
							our runners try to complete some of your favourite
							games as quickly as possible. ASM2022 will be
							running for almost 5 consecutive days, with over 100
							hours of content! This event will be livestreamed on
							twitch, as well as viewable in person, in Adelaide,
							Australia!
						</p>
					</div>
				...
				<div className={styles.contentRow}>
					...
					<div className={styles.moreInfo}>
						<p>
							...
							<br />
							<br />
							Follow us on Twitter or Join the Discord to stay up
				...
				<div className={styles.contentRow}>
					<div className={styles.moreInfo}>
						<p>
							We are super excited to be supporting Cure Cancer
							through its Game on Cancer initiative. Cure Cancer
							has been raising money for 55 years to fund early
							career cancer researchers. Over 540 research grants
							have been funded thanks to Cure Cancer donors and
							partners.
						</p>
					</div>
					<div className={styles.image}>
